    ...
    <div className={`transition-colors duration-500 ${darkMode ? "dark" : ""}`}>
      ...
      <main className="bg-slate-200 px-4 sm:px-10 md:px-20 lg:px-40 xl:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-4 sm:py-10 mb-12 flex flex-col sm:flex-row justify-between items-center dark:text-white animate-fadeInTop">
        ...
        <section>
          <div>
            ...
            <div className="flex justify-center pt-5 dark:text-gray-200">
              <Image src={JS} className="mr-4 animate-fadeInLeft" />
              <Image src={python} className="mr-4 animate-fadeInLeft" />
              <Image src={HTML} className="mr-4 animate-fadeInLeft" />
              <Image src={CSS} className="mr-4 animate-fadeInForward" />
              <Image src={Node} className="mr-4 animate-fadeInForward" />
              <Image src={react} className="mr-4 animate-fadeInForward" />
              <Image src={figma} className="mr-4 animate-fadeInRight" />
              <Image src={PowerBI} className="mr-4 animate-fadeInRight" />
              <Image src={SQL} height={48} width={48} className="animate-fadeInRight" />
            </div>
          </div>
        </section>
